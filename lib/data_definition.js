define(module, (exports, require) => {
  ...
  qp.make(exports, {
    ...
    drop_user: function(data, done) {
      this.execute([ 'DROP USER IF EXISTS', data.user ], done);
    },
    ...
    drop_database: function(data, done) {
      this.execute([ 'DROP DATABASE IF EXISTS', data.database.name ], done);
    },
    ...
    create_sequences: function(data, done) {
      ...
      else this.execute(sequences, done);
    },

    create_sequence: function(data, done) {
      this.execute([ 'CREATE SEQUENCE IF NOT EXISTS', data.sequence_name ], done);
    },
    ...
    drop_sequence: function(data, done) {
      this.execute([ 'DROP SEQUENCE IF EXISTS', data.sequence_name ], done);
    },
    ...
    drop_table: function(data, done) {
      this.execute([ 'DROP TABLE IF EXISTS', data.table.fullname ], done);
    },

    rename_table: function(data, done) {
      this.execute([ 'ALTER TABLE', data.table.fullname, 'RENAME TO', data.to ], done);
    },
    ...
    remove_column: function(data, done) {
      this.execute([ 'ALTER TABLE', data.table.fullname, 'DROP COLUMN', data.column.name ], done);
    },
    ...
    create_indexes: function(data, done) {
      ...
      else this.execute(indexes, done);
    },

    create_index: function(data, done) {
      this.execute(this.create_index_statement(data), done);
    },
    ...
    drop_index: function(data, done) {
      this.execute([ 'DROP INDEX IF EXISTS', data.index.name ], done);
    },
    ...
    create_triggers: function(data, done) {
      ...
      else this.execute(triggers, done);
    },

    create_trigger: function(data, done) {
      this.execute(this.create_trigger_command(data), done);
    },
